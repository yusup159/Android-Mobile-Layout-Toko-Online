...
class ProductFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        val tambahbarang : ImageView = view.findViewById(R.id.tambahbarang)
        ...
        val sembar : TextView = view.findViewById(R.id.semuaproduct)
        sembar.setOnClickListener {
            val fragment = FragmentListSemuaBarang()
            val transaction = fragmentManager?.beginTransaction()
            transaction?.replace(R.id.fragmentContainer, fragment)?.commit()
        }
        val btnacv : ImageView= view.findViewById(R.id.account)
        btnacv.setOnClickListener {
